...
def get_image_base64(image_url):
    image_decoded = requests.get(image_url).content
    image_encoded = base64.b64encode(image_decoded).decode()
    return f'data:image/png;base64,{image_encoded}'


def restituisci_coordinate_da_indirizzo_approssimativo(indirizzo):
...
def build_html_popup(name, address, url_video, url_thumbnail_encoded):
    html_content = f"""
    <html>
        <head>
            <style>
        ...
        <body>
            <div class="popup-content">
                ...
                <a href="{url_video}" target="{url_video}">
                    <img src="{url_thumbnail_encoded}" style="width: 80%; height: auto;">
                </a>
            </div>
        </body>
    </html>
